...
Architecture of Modernise-TradeMaster framework could be visualizaed by the figure below.
- Level 1 Simulation
...
- Level 3 Evaluation
  ...
  Modernise-TradeMaster is evaluated in multiple dimenstions. Financial metrics like profit and risk metrics are applied. Additionally, decision tree and shapley value are used to evaluate the explainability of the model. Variability and Alpha decay are used for reliability evaluation.
