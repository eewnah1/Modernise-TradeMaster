...
## Notebook and Script
In this notebook, we implement the training and testing process of HFTDDQN based on the Modernise-TradeMaster framework.

[Tutorial5_HFT](https://github.com/eewnah1/Modernise-TradeMaster/blob/main/tutorial/Tutorial5_HFT.ipynb)

And this is the script for training and testing.

[train.py](https://github.com/eewnah1/Modernise-TradeMaster/blob/1.0.0/tools/high_frequency_trading/train.py)